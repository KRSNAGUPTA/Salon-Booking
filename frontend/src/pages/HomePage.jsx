        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16 py-12 md:py-16 lg:py-20">
          <div className="flex flex-col lg:flex-row items-center lg:gap-12">
            ...
            <div className="lg:w-1/2">
              <div className="relative w-max h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px]">
                <img
                  src="/salon.png"
                  alt="Salon scene"
                  className="w-full h-full bg-transparent object-cover rounded-lg "
                />
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Book instantly from anywhere",
              },
              {
                title: "Trusted Reviews & Ratings",
                description: "Genuine feedback from customers",
              },
            ].map((feature, index) => (
